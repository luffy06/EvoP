...
from comparisons.slicegpt.slicegpt.model_adapter import ModelAdapter, SlicingConfig
from comparisons.slicegpt.slicegpt.rotate import slice_rotated_model
